...
for k in array:
    ...
    plt.title('2017年%s售货机最后20天销售额预测值对比图对比图' % (k), loc='center',
              bbox=dict(facecolor='yellow', edgecolor='red', alpha=0.8), fontsize='xx-large', fontweight='bold')
    plt.subplots_adjust(left=None, bottom=None, right=None, top=None,
                        wspace=0.3, hspace=0.3)
    p1.savefig('C:/Users/Administrator/Desktop/项目数据/可视化/2017年%s售货机最后20天销售额预测值对比图对比图.png' % (k))